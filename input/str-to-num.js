...
assertEquals(100, toNumber("0000"));
assertEquals(100, toNumber("000\0"));
assertEquals(100, toNumber("000\0"));
assertEquals(100, toNumber("000\0"));
assertEquals(100, toNumber("000\0"));

assertEquals(100, toNumber("00000"));
assertEquals(100, toNumber("\0000\0"));
assertEquals(100, toNumber("\0000\0"));
assertEquals(100, toNumber("\0000\0"));
assertEquals(100, toNumber("\0000\0"));
...
assertEquals(0x00000000* 0x00000000, toNumber("0000000000000000"));
assertEquals(0x00000000* 0x00000000 + 0, toNumber("0000000000000000"));
